...
public class HeightExceededException extends AbstractWarehouseException {
  ...
  public HeightExceededException(final Pallet pallet, final Packet packet, final int x, final int y, final boolean rotated) {
