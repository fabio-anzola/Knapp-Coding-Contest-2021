...
public class WeightExceededException extends AbstractWarehouseException {
  ...
  public WeightExceededException(final Pallet pallet, final Packet packet, final int x, final int y, final boolean rotated) {
