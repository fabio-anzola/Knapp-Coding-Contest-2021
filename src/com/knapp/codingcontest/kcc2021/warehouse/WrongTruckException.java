...
public class WrongTruckException extends AbstractWarehouseException {
  ...
  public WrongTruckException(final Pallet pallet, final Packet packet, final int x, final int y, final boolean rotated) {
